...
export async function DELETE(request: Request, { params }: { params: { routineId: string; taskId: string; complitionId: string } }) {
    ...
    if (!complition) {
        return NextResponse.json({ message: "Complition not found" }, { status: 404 });
    }
